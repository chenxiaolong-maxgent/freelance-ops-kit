...
export const metadata: Metadata = {
  ...
  title: '接单经营全家桶 — 报价、变更、利润、回款一套守住',
  description: '报价匠 PRO、ScopeGuard PRO、RetainerFit PRO、ProfitLens PRO 与 CashRadar PRO 组合套装，覆盖报价、月费、范围、利润与回款。',
  alternates: { canonical: 'https://chenxiaolong-maxgent.github.io/freelance-ops-kit/' },
  openGraph: {
    type: 'website',
    title: '接单经营全家桶 — 报价 · 变更 · 利润 · 回款',
    description: '五个完整商品加独家工作流，一套守住自由职业项目利润。',
